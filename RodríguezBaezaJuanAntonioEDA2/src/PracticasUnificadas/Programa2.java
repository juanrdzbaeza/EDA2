	...
	private static void guardarGruposTXT(ArrayList<Grupo> lista, String archivo, double tiempo) {
		...
		try {
			...
			for (int i = 0; i < lista.size(); i++) {
				...
				System.out.println("Total Manzanas --> " + (lista.get(i).totalMan()+1));
				System.out.println("Total Absentismo --> " + lista.get(i).totalAbs() + "\n");
				System.out.println("--------------------------------------------------------------------------------------------------------");
			...
			for (int i = 0; i < lista.size(); i++) {
				f.write(lista.get(i).toString() + "\n");
				f.write("Total Manzanas --> " + (lista.get(i).totalMan()+1) + "\n");
				f.write("Total Absentismo --> " + lista.get(i).totalAbs() + "\n");	
